...
# Title: SIgnal Visualization HackRF
# Author: pentoo
...
class SignalVisualization(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "SIgnal Visualization HackRF")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("SIgnal Visualization HackRF")
        ...
        self.settings = Qt.QSettings("GNU Radio", "SignalVisualization")
        ...
        self.channel_freq = channel_freq = 96300000
        self.center_freq = center_freq = 98700000
...
def main(top_block_cls=SignalVisualization, options=None):

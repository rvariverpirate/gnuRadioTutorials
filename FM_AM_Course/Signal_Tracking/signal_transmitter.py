...
class signal_transmitter(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Signal Transmitter")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Signal Transmitter")
        ...
        self.settings = Qt.QSettings("GNU Radio", "signal_transmitter")
        ...
        # Variables
        ##################################################
        self.throttled_rate = throttled_rate = 1e6
        self.samp_rate = samp_rate = 1e6
        self.center_freq = center_freq = 433.92e6
        self.baud_rate = baud_rate = 1.631e3
        ...
        self.qtgui_number_sink_0.set_title('Byte Sink')
        ...
        self.blocks_throttle_0 = blocks.throttle(gr.sizeof_gr_complex*1, throttled_rate,True)
        self.blocks_threshold_ff_0 = blocks.threshold_ff(0.05, 0.15, 0)
        self.blocks_keep_one_in_n_0 = blocks.keep_one_in_n(gr.sizeof_float*1, 613)
        ...
        self.connect((self.blocks_unpacked_to_packed_xx_0, 0), (self.qtgui_number_sink_0, 0))
    ...
    def get_throttled_rate(self):
        return self.throttled_rate

    def set_throttled_rate(self, throttled_rate):
        self.throttled_rate = throttled_rate
        self.blocks_throttle_0.set_sample_rate(self.throttled_rate)
...
def main(top_block_cls=signal_transmitter, options=None):

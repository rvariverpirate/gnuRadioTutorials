...
class pskUpsamplingAndPulseShaping(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "PSK Generation")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("PSK Generation")
        ...
        self.settings = Qt.QSettings("GNU Radio", "pskUpsamplingAndPulseShaping")
...
def main(top_block_cls=pskUpsamplingAndPulseShaping, options=None):

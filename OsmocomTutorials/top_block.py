...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.osmosdr_source_0_0.set_sample_rate(samp_rate*4)
        self.osmosdr_source_0_0.set_center_freq(26e6, 0)
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_gr_complex*1, '/home/pentoo/Desktop/gnuRadioTutorials/5_imparmentsOfWireless/test.txt', True, 0, 0)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.osmosdr_source_0_0.set_sample_rate(self.samp_rate*4)

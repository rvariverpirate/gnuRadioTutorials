...
class qpskGeneration(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "qpskGeneration")
...
def main(top_block_cls=qpskGeneration, options=None):
